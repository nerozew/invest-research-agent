#!/usr/bin/env bash
# Phase 4 一键部署（Ubuntu / 任意带 Docker 的主机）
#
...
GHCR_IMAGE="ghcr.io/nerozew/invest-research-agent:phase4"

# ==== 第 1 步：拉取最新 phase4 镜像 ====
...
echo "DEPLOY_PHASE4_OK (digest ${PULLED_DIGEST})"